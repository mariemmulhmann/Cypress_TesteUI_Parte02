...
class EnderecoPage {
    ...
    editalEndereçoFaturamento(nome, sobrenome, empresa, pais, endereco, numero, cidade, estado, cep, celular, email) {
    ...
    editarEndereçoEntrega(nome, sobrenome, empresa, pais, endereco, numero, cidade, estado, cep) {
        cy.get('.woocommerce-MyAccount-navigation-link--edit-address > a').click()
